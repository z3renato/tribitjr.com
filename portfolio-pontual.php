...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Colégio Pontual
                        <small></small>
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Colégio Pontual</li>
                    </ol>
                </div>
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive" src="imagens/portfolio/pontual/pontual1.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive" src="imagens/portfolio/pontual/pontual2.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive" src="imagens/portfolio/pontual/pontual3.jpg" alt="">
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <h3>Descrição</h3>
                    <p>Website com sistema de gerenciamento escolar.</p>
                    <h3>Detalhes</h3>
                    <ul>
