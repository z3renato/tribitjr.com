...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">DietSmart
                        <small></small>
                    </h1>
                    <ol class="breadcrumb">
                    ...
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive" src="imagens/portfolio/dietsmart/dietsmart1.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive" src="imagens/portfolio/dietsmart/dietsmart2.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive" src="imagens/portfolio/dietsmart/dietsmart3.jpg" alt="">
                            </div>
                        </div>
